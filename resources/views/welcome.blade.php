<x-guest-layout>
    ...
    <div
        ...
        style="background-image: url(https://cdn.pixabay.com/photo/2020/02/17/11/00/dj-4856147_960_720.jpg)">
        <h1
            ...
            <span class="inline md:block">Welcome To Lumi NightClub</span>
        </h1>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold text-green-400">About Us</h2>
                        <h2
            ...
            <div class="flex flex-wrap items-center sm:-mx-3">
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                      ...
                      > -->
                        <h2 class="text-4xl text-green-600">CLUB INFO</h2>
                        <!-- </h1> -->
