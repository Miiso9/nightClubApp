    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.tables.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indig0-700 rounded-lg">Table Index</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            <label for="name" class="block text-sm font-medium text-gray-700"> Table </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="guest_number"
                                   class="block text-sm font-medium text-gray-700"> Guest Number</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-spam-6">
                            <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                            <div class="mt-1">
                                <select id="status" name="status" class="fore-multiselect block w-full mt-1">
                        ...
                        <div class="sm:col-spam-6">
                            ...
                            <div class="mt-1">
                                <select id="location" name="location" class="fore-multiselect block w-full mt-1">
